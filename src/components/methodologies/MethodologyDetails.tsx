...
// Apply similar styling patterns to the other methodology details
        ...
        <Tabs defaultValue="overview">
          ...
          <TabsContent value="mathematics" className="space-y-6 mt-6 animate-fade-in">
            <div>
              ...
              <div className="bg-white rounded-xl shadow-sm border p-6 space-y-6">
                <div>
                  <h4 className="text-lg font-semibold mb-3 text-purple-800">Causal Inference Framework</h4>
                  <p className="mb-3">The fundamental concept in incrementality testing comes from the Rubin Causal Model:</p>
